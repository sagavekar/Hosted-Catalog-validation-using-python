        ...
        if str(i[0].value).strip().lower() == "update":
            ...
            for j in system_data_sheet.iter_rows(min_row=2):
                ...
                if str(j[4].value).strip() == SIN:  # Match found
                    ...
                    supplier_data_sheet.cell(
                        row=row_num_from_supplier_data_sheet, column=22
                    ).value = Manufacturer_Part_Number[0:256] if Manufacturer_Part_Number != "None" else ""
                    ...
                    supplier_data_sheet.cell(
                        row=row_num_from_supplier_data_sheet, column=23
                    ).value = Manufacturer_Model_Number[0:500] if Manufacturer_Model_Number != "None" else ""
                    ...
                    if str(i[0].value).strip() == "UPdate":
                        supplier_data_sheet.cell(
                        row=row_num_from_supplier_data_sheet, column=31).value = datetime.datetime.today().strftime("%m/%d/%Y")
...
root.title(
    "ABM Catalog Validator | @ Omkar.Sagavekar@GEP.com",
)
